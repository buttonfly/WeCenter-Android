...
public class AskingFragmentActivity extends FragmentActivity {
	...
	private org.iflab.wc.common.MyProgressDialog progressDialog;
	...
	public void postpic(RequestParams params, String id, String attach) {
		...
		String url = WecenterApi.POST_PIC + "?id=" + id
	...
	public void quespost(RequestParams params) {
		String url = WecenterApi.POST_QUESTION;
		client.post(url, params, new AsyncHttpResponseHandler() {
	...
	public static void actionStar(Context context) {
		Intent intent = new Intent(context, AskingFragmentActivity.class);
