	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(MyAnswerActivity.this,
				...
				try {
					...
					if (errno != 1) {
						...
						for (int i = 0; i < jsonArray.length(); i++) {
							...
							data.setQuestion_id(Integer.valueOf(question_id));
							data.setAnswer_id(Integer.valueOf(answer_id));
							data.setAnswer_content(answer_content);
							data.setAgree_count(Integer.parseInt(agree_count));
