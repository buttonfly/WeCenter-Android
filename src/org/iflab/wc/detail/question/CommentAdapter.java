...
public class CommentAdapter extends BaseAdapter {
	...
	public View getView(final int arg0, View arg1, ViewGroup arg2) {
		...
		Matcher m = p.matcher(comitems.get(arg0).getAnswer_content());
		String content = m.replaceAll("图片");
		...
		getUserNamImage.getuserinfo(comitems.get(arg0).getUid(), hodler.name,
				hodler.imageView, new onLoaderListener() {
					...
					public void onNameLoader(String name, TextView username) {
						// TODO Auto-generated method stub
						if (username.getTag() != null
								&& username.getTag().equals(
										comitems.get(arg0).getUid() + "name")) {
