...
public class WriteAnswerActivity extends Activity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 0:
			if (resultCode != RESULT_CANCELED && null != data) {
				...
				Toast.makeText(this, "取照片失败！", Toast.LENGTH_LONG).show();
			}
			break;
		case 1:
	...
	public void postpic(RequestParams params, String id, String attach) {
		...
		client.post(url, params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
				...
				if (errno == 1) {
					Toast.makeText(WriteAnswerActivity.this, "上传成功！",
				...
				if (errno == -1) {
					Toast.makeText(WriteAnswerActivity.this, err,
							Toast.LENGTH_LONG).show();
				}
			}
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (arg2 == bmp.size()) {
					...
					if (Environment.MEDIA_MOUNTED.equals(sdcardState)) {
						...
						Toast.makeText(WriteAnswerActivity.this,
								"sdcard已拔出，不能选择照片", Toast.LENGTH_SHORT).show();
					}
				} else {
				}
			}
