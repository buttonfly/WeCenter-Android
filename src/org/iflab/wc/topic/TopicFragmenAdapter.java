...
public class TopicFragmenAdapter extends BaseAdapter {
	...
	public TopicFragmenAdapter(Context context, List<TopicModel> topicModels,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHodler.topicTitle
				.setText(topicModels.get(position).getTopicTitle());
		viewHodler.topicSummary.setText(topicModels.get(position)
				.getTopicSummary());
